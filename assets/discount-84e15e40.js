import{a as i,P as S}from"./vendor-b592f4c5.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))c(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&c(r)}).observe(document,{childList:!0,subtree:!0});function n(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerpolicy&&(s.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?s.credentials="include":e.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(e){if(e.ep)return;e.ep=!0;const s=n(e);fetch(e.href,s)}})();const m="https://food-boutique.b.goit.study/api/";i.defaults.baseURL=m;async function w({keyword:t,category:o,page:n,limit:c,sort:e}={}){const s={keyword:t,category:o,page:n,limit:c};return e&&e.key&&e.value&&(s[e.key]=e.value),(await i.get(`${m}products`,{params:s})).data}async function C(t){return(await i.get(`${m}products/popular`,{params:{limit:t}})).data}document.querySelector(".js-item-count");document.querySelector(".js-empty-basket");document.querySelector(".js-filled-basket");document.querySelector(".js-items-container");document.querySelector(".total-count-text");document.querySelector(".checkout-form");const I=document.getElementById("countProducts");let B=0;document.getElementById("cartLink").addEventListener("click",()=>{I.innerHTML=`cart (${++B})`});const u="Java Script";console.log(u.length-1);console.log(u[u.length]);const l=document.getElementById("modalProduct"),M=document.getElementById("closeModalProductBtn"),x=document.getElementById("addToCartBtn"),j=document.getElementById("modalProductImage"),q=document.getElementById("modalProductName"),A=document.getElementById("modalProductCategory"),_=document.getElementById("modalProductSize"),z=document.getElementById("modalProductPopularity"),O=document.getElementById("modalProductDescription"),N=document.getElementById("modalProductPrice");function P(t){if(!t||!t.img){console.error("Product data is missing or incomplete.");return}j.src=t.img,q.textContent=t.name,A.textContent=`Category: ${t.category}`,_.textContent=`Size: ${t.size}`,z.textContent=`Popularity: ${t.popularity}`,O.textContent=t.description,N.textContent=`Price: ${t.price}`,document.body.style.overflow="hidden",l.style.display="block",window.addEventListener("click",b)}function d(){document.body.style.overflow="",l.style.display="none",window.removeEventListener("click",b)}M.addEventListener("click",d);window.addEventListener("click",function(t){t.target===l&&d()});document.addEventListener("keydown",function(t){t.key==="Escape"&&d()});function b(t){t.target===l&&d()}window.addEventListener("click",function(t){t.target===l&&d()});x.addEventListener("click",function(){d()});const T=document.querySelector(".list-prod"),y={keyword:"",category:"",page:1,limit:9};function D(t,o){t.innerHTML=o}async function E(t){try{y.page=t;const{results:o}=await w(y);console.log("Products:",o);const n=H(o);D(T,n),document.querySelectorAll(".prod-item").forEach(e=>{e.addEventListener("click",()=>{const s=e.getAttribute("data-js-product-id"),r=o.find(a=>a._id.toString()===s);r?P(r):console.error("Selected product not found:",s)})})}catch(o){console.error(o)}}function H(t){return t.map(({_id:o,name:n,img:c,category:e,size:s,price:r,popularity:a})=>`
      ...
      `).join("")}E();const R=9;let J=540;let p=1;const U=document.getElementById("pagination"),K=new S(U,{totalItems:J,itemsPerPage:R,visiblePages:5,centerAlign:!0});K.on("beforeMove",t=>{p=t.page,k(p)});async function k(t){E(t)}k(p);const v=document.querySelector(".popular-list");C(5).then(t=>{v.insertAdjacentHTML("beforeend",F(t));function o(n){let c=n.target;if(c.closest(".popular-card")){const s=c.closest(".popular-card").getAttribute("data-js-product-id"),r=t.find(a=>a._id.toString()===s);P(r)}else c.closest(".btn-add")&&(c.closest(".btn-add").classList.add("visually-hidden"),alert("Product add to Order"))}v.addEventListener("click",o)}).catch(t=>{console.error(t)});function F(t){return t.map(({_id:o,name:n,img:c,category:e,popularity:s,size:r,price:a})=>{const L=parseInt(s.toString()[0]);return`  <li class="popular-item">
...
`).join("")}let g=[];const f=document.querySelector(".products-discount");console.log(f);async function Q(){g=(await G()).slice(0,2);const o=Y(g);V(o)}Q();function V(t){f.insertAdjacentHTML("beforeend",t)}f.addEventListener("click",X);function X(t){if(!t.target.closest(".cart-product-btn"))return;const n=t.target.closest(".cart-product-discount").dataset.id,c=W();if(c.find(e=>n===e._id))h(c.filter(e=>n!==e._id));else{const e=g.find(s=>n===s._id);c.push(e),h(c)}}
//# sourceMappingURL=discount-84e15e40.js.map
