import{g as l,S as r,b as D,m as J,s as g,d as E,e as y,f as G,F as et,a as m,h as R,i as ot,j as st,k as nt,o as ct}from"./assets/STORAGE-0c41f7f0.js";import{P as at,a as rt,l as dt}from"./assets/vendor-8c378b12.js";document.getElementById("addToCartIcon");const it=document.getElementById("removeFromIcon");it.classList.add("visually-hidden");const C=document.getElementById("modalProduct"),lt=document.getElementById("closeModalProductBtn"),B=document.getElementById("addToCartBtn"),x=document.getElementById("removeFrom"),ut=document.getElementById("modalProductImage"),pt=document.getElementById("modalProductName"),mt=document.getElementById("modalProductCategory"),gt=document.getElementById("modalProductSize"),ft=document.getElementById("modalProductPopularity"),yt=document.getElementById("modalProductDescription"),ht=document.getElementById("modalProductPrice"),vt=document.querySelector(".modal-overlay");const X=document.getElementById("scrollToTopBtn");function M(t){try{let s=function(){e.push(t),c(e)},n=function(){e.splice(o,1),c(e)},c=function(a){g(r,e),E(),a=D(e,t),y(t._id,a),J(a,B,x)};if(!t||!t.img){console.error("Product data is missing or incomplete.");return}C.style.display="block",document.body.style.overflow="hidden",document.querySelector(".modal-overlay").style.display="flex",window.addEventListener("click",z),B.addEventListener("click",s),x.addEventListener("click",n);const e=l(r);let o=D(e,t);J(o,B,x),X.style.display="none";ut.src=t.img,pt.textContent=t.name,mt.innerHTML=`Category: <span id="priceText"> ${t.category.replace(/_/g," ")}</span>`,document.getElementById("priceText").style.color="black",gt.innerHTML=`Size: <span id="priceTexte"> ${t.size}</span>`,document.getElementById("priceTexte").style.color="black",ft.innerHTML=`Popularity: <span id="priceTex"> ${t.popularity}</span>`,document.getElementById("priceTex").style.color="black",yt.textContent=`${t.desc}`,ht.textContent=`$ ${t.price}`,C.style.display="block",document.body.style.overflow="hidden",document.querySelector(".modal-overlay").style.display="block",window.addEventListener("click",z)}catch{console.log("no proructs")}}function j(){document.body.style.overflow="",C.style.display="none",document.querySelector(".modal-overlay").style.display="none",X.style.display="flex";}lt.addEventListener("click",j);document.addEventListener("keydown",function(t){t.key==="Escape"&&j()});function z(t){t.target===vt&&j()}const F=document.querySelector(".list-prod");l(r);function bt(t,e){t.innerHTML=e}async function H(t){const e=Lt(t);bt(F,e)}F.addEventListener("click",St);F.addEventListener("click",Et);function St(t){const e=t.target.closest(".buy-btn");if(!e)return;const s=t.target.closest(".prod-item").getAttribute("data-js-product-id");e.querySelectorAll("svg[data-js-product='"+s+"']");const n=l(r);let c=n.findIndex(a=>a._id===s);if(c!==-1)n.splice(c,1),c=-1;else{const a=l(et).find(d=>d._id===s);a&&(n.push(a),c=0)}g(r,n),y(s,c)}function Et(t){const e=t.target.closest(".prod-item"),o=t.target.closest(".buy-btn");if(!e||o)return;const s=e.getAttribute("data-js-product-id");G(s).then(n=>{M(n)}).catch(n=>{console.error(n)})}function Lt(t){return t.map(({_id:e,name:o,img:s,category:n,size:c,price:a,popularity:d,is10PercentOff:u})=>{const p=l(r),h=p.find(k=>k._id===e)?"":"is-hidden",f=p.find(k=>k._id===e)?"is-hidden":"",w=wt(u);return`
...
`}).join("")}function At(t,e){return t.length>e?t.slice(0,e-1)+"…":t}let $=[];const N=document.querySelector(".products-discount");async function Ct(){$=(await nt()).slice(0,2);const e=l(r),o=jt(e),s=Tt($,o);_t(s)}Ct();function _t(t){N.insertAdjacentHTML("beforeend",t)}N.addEventListener("click",qt);N.addEventListener("click",Mt);function qt(t){const e=t.target.closest(".card-product-btn");if(!e)return;const o=t.target.closest(".card-product-discount");e.querySelectorAll("svg");const s=o.dataset.id,n=l(r);if(n.find(c=>s===c._id))g(r,n.filter(c=>s!==c._id)),E(),y(s,-1);else{const c=$.find(a=>s===a._id);n.push(c),g(r,n),E(),y(s,0)}}function Mt(t){const e=t.target.closest(".card-product-discount"),o=t.target.closest(".card-product-btn");if(!e||o)return;const s=e.dataset.id,n=$.find(c=>s===c._id);M(n)}function jt(t=[]){return t.map(e=>e._id)}const i=document.querySelector(".feedback-form");i.addEventListener("submit",tt);const L="feedback-form-state",Z=document.getElementById("footer-button"),b={menu:document.querySelector("[data-menu]"),one:document.querySelector("[data-one]"),two:document.querySelector("[data-two]")};i.addEventListener("submit",tt);function tt(t){t.preventDefault();const e=i.elements.email.value;ct(e).then(o=>{o.message&&(b.menu.classList.remove("is-hidden"),b.one.classList.remove("is-hidden")),b.two.classList.add("is-hidden")}).catch(o=>{b.menu.classList.remove("is-hidden"),b.two.classList.remove("is-hidden")})}const Ft=dt(()=>{const t={email:i.elements.email.value};localStorage.setItem(L,JSON.stringify(t))},500);window.addEventListener("load",()=>{const t=localStorage.getItem(L);if(t){const{email:e}=JSON.parse(t);i.elements.email.value=e}});i.addEventListener("input",()=>{Ft(),I()});i.addEventListener("submit",t=>{t.preventDefault(),i.elements.email.value,localStorage.removeItem(L),i.reset(),I()});Z.addEventListener("click",function(){const t=localStorage.getItem(L);if(t){const{email:e}=JSON.parse(t);i.elements.email.value=e,I()}});const I=()=>{const t=i.elements.email.value,e=Ot(t),o=t.trim()!=="";Z.disabled=!(e&&o)},Ot=t=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t),Nt=()=>{const t=localStorage.getItem(L);if(t){const{email:e}=JSON.parse(t);i.elements.email.value=e,I()}};Nt();document.body.style.overflow="auto";(()=>{const t={openMenuBtn:document.querySelector("[data-menu-open]"),closeMenuBtn:document.querySelector("[data-menu-close]"),menu:document.querySelector("[data-menu]")};Array.from(t.menu.children).forEach(s=>{s.addEventListener("click",o)});function o(){t.menu.classList.add("is-hidden"),document.body.classList.remove("no-scroll"),document.body.style.overflow="auto"}})();const q=document.getElementById("scrollToTopBtn"),Y=360;window.onscroll=function(){document.body.scrollTop>Y||document.documentElement.scrollTop>Y?q.classList.add("show"):q.classList.remove("show")};q.addEventListener("click",function(){window.scrollTo({top:0,behavior:"smooth"})});
