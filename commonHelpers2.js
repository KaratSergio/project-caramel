import{g as u,S as d,b as D,m as J,s as m,d as L,e as v,f as Y,F as ot,a as p,h as R,i as st,j as nt,k as ct,o as at}from"./assets/STORAGE-c547887d.js";import{P as it,a as dt,l as rt}from"./assets/vendor-8c378b12.js";const lt=document.getElementById("removeFromIcon"),G=document.getElementById("modalProduct"),ut=document.getElementById("closeModalProductBtn"),B=document.getElementById("addToCartBtn"),x=document.getElementById("removeFrom"),pt=document.getElementById("modalProductImage"),mt=document.getElementById("modalProductName"),gt=document.getElementById("modalProductCategory"),ft=document.getElementById("modalProductSize"),ht=document.getElementById("modalProductPopularity"),yt=document.getElementById("modalProductDescription"),vt=document.getElementById("modalProductPrice"),_=document.querySelector(".modal-overlay"),X=document.getElementById("scrollToTopBtn");lt.classList.add("visually-hidden");function j(t){if(!t||!t.img){console.error("Product data is missing or incomplete.");return}G.style.display="block",document.body.style.overflow="hidden",_.style.display="flex",window.addEventListener("click",Z);const e=u(d);let o=D(e,t);J(o,B,x),B.addEventListener("click",n),x.addEventListener("click",c),X.style.display="none",pt.src=t.img,mt.textContent=t.name;const s=i=>i.replace(/_/g," ");gt.innerHTML=`Category: <span id="priceText">${s(t.category)}</span>`,document.getElementById("priceText").style.color="black",ft.innerHTML=`Size: <span id="priceTexte">${t.size}</span>`,document.getElementById("priceTexte").style.color="black",ht.innerHTML=`Popularity: <span id="priceTex">${t.popularity}</span>`,document.getElementById("priceTex").style.color="black",yt.textContent=`${t.desc}`,vt.textContent=`$ ${t.price}`;function n(){e.push(t),a()}function c(){e.splice(o,1),a()}function a(){m(d,e),L(),o=D(e,t),v(t._id,o),J(o,B,x)}}function q(){document.body.style.overflow="",G.style.display="none",_.style.display="none",X.style.display="flex",window.removeEventListener("click",Z)}ut.addEventListener("click",q);document.addEventListener("keydown",function(t){t.key==="Escape"&&q()});function Z(t){t.target===_&&q()}const O=document.querySelector(".list-prod");u(d);function bt(t,e){t.innerHTML=e}async function z(t){const e=Lt(t);bt(O,e)}O.addEventListener("click",St);O.addEventListener("click",wt);function St(t){const e=t.target.closest(".buy-btn");if(!e)return;const s=t.target.closest(".prod-item").getAttribute("data-js-product-id");e.querySelectorAll("svg[data-js-product='"+s+"']");const n=u(d);let c=n.findIndex(a=>a._id===s);if(c!==-1)n.splice(c,1),c=-1;else{const a=u(ot).find(i=>i._id===s);a&&(n.push(a),c=0)}m(d,n),v(s,c)}function wt(t){const e=t.target.closest(".prod-item"),o=t.target.closest(".buy-btn");if(!e||o)return;const s=e.getAttribute("data-js-product-id");Y(s).then(n=>{j(n)}).catch(n=>{console.error(n)})}function Lt(t){return t.map(({_id:e,name:o,img:s,category:n,size:c,price:a,popularity:i,is10PercentOff:l})=>{const g=u(d),b=g.find(h=>h._id===e)?"":"is-hidden",I=g.find(h=>h._id===e)?"is-hidden":"",f=Et(l);return`
      ...
      `}).join("")}function Et(t){return t===!0?"visible":"hidden"}const S=document.querySelector("#pagination"),H=document.querySelector(".list-prod-container"),V=document.querySelector(".filter-nomatches-container"),U="firstset";F("first");async function F(t){const{keyword:e,category:o}=t;let s=9;window.matchMedia("(max-width: 767px)").matches?s=6:window.matchMedia("(min-width: 768px) and (max-width: 1439px)").matches&&(s=8);const n={keyword:e||"",category:o||"",page:1,limit:s},{results:c,totalPages:a}=await R(n);if(a===0?(H.classList.add("visually-hidden"),V.classList.remove("visually-hidden"),S.classList.add("visually-hidden")):(H.classList.remove("visually-hidden"),V.classList.add("visually-hidden"),S.classList.remove("visually-hidden")),m(U,c),z(c),a){let i=1;a>1&&(window.matchMedia("(max-width: 767px)").matches?i=3:window.matchMedia("(min-width: 768px)").matches&&(i=5));const l={totalItems:c.length*a,itemsPerPage:n.limit,visiblePages:i,page:1,centerAlign:!0,usageStatistics:!1,template:{moveButton:'<a href="#" class="tui-page-btn need-hide tui-{{type}}"><span class="for-add-text-{{type}}">1</span><span class="tui-ico-{{type}}">{{type}}</span></a>',moreButton:'<span  class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></span>'}};new it(S,l).on("afterMove",async f=>{n.page=f.page;const{results:h}=await R(n);m(U,h),z(h)});const b=document.querySelector(".for-add-text-first"),I=document.querySelector(".for-add-text-last");if(b){const f=document.querySelector(".for-add-text-first");f.textContent=1}if(I){const f=document.querySelector(".for-add-text-last");f.textContent=a}a===1?S.classList.add("visually-hidden"):S.classList.remove("visually-hidden")}}class Pt{constructor(){this.URL="https://food-boutique.b.goit.study/api",this.searchQuery="",this.category="",this.currentPage=1,this.perPage=6}paramsFromApi(e){return Object.entries(e).map(([o,s])=>`${encodeURIComponent(o)}=${encodeURIComponent(s)}`).join("&")}getFoodList(){const e={keyword:this.searchQuery,category:this.category,page:this.currentPage,limit:this.perPage},o=this.paramsFromApi(e);return dt.get(`${this.URL}/products?${o}`).then(s=>s.data)}}class $t{updateLsWithList(e){const o={keyword:null,category:null,page:1,limit:6};localStorage.setItem("products",JSON.stringify(e.results)),localStorage.setItem("options",JSON.stringify(o))}clearLocalStorage(){localStorage.reset("products"),localStorage.reset("options")}defaultApiOptions(){const e={keyword:null,category:null,page:1,limit:6};localStorage.setItem("options",JSON.stringify(e))}}const K=document.querySelector(".filter-form"),P=document.querySelector(".filter-select");document.querySelector("filter-search");const T=new Pt,w=new $t;st().then(t=>{t.forEach(o=>{const s=document.createElement("option");s.value=o,s.textContent=o.split("_").join(" "),P.append(s)});const e=kt();P.append(e)});function kt(){const t=document.createElement("option");return t.textContent="Show All",t.value="",t}K.addEventListener("submit",function(t){t.preventDefault();let e=t.target.elements.searchQuery.value.trim();try{let o=JSON.parse(localStorage.getItem("options"))||{};e===""?(o.keyword=null,w.clearLocalStorage(),w.defaultApiOptions()):(o.keyword=e,T.getFoodList(o).then(function(s){w.updateLsWithList(s,o),F(o)}).catch(function(s){console.error("Error fetching food list:",s.message)}))}catch(o){console.error("Error:",o.message)}K.reset()});P.addEventListener("change",function(){const t=P.value;try{let e=JSON.parse(localStorage.getItem("options"))||{};t==="show-all"?(localStorage.removeItem("products"),w.defaultApiOptions()):(e.category=t,T.category=t,T.getFoodList().then(function(o){w.updateLsWithList(o,e),F(e)}).catch(function(o){console.error("Error fetching list:",o.message)}))}catch(e){console.error("Error:",e.message)}});const Q=document.querySelector(".popular-product-list");let tt=5;window.matchMedia("(min-width: 768px) and (max-width: 1439px)").matches&&(tt=6);nt(tt).then(t=>{Q.insertAdjacentHTML("beforeend",xt(t)),[...document.getElementsByClassName("button-remove-product")].forEach(s=>{const n=s.getAttribute("data-js-button"),c=A(n,t);M(c._id)&&s.nextElementSibling.classList.add("visually-hidden")});function o(s){let n=s.target;if(n.closest(".popular-card")){const a=n.closest(".popular-card").getAttribute("data-js-product-id");It(a)}else if(n.closest(".button-add-product")){const c=n.closest(".button-add-product").previousElementSibling,a=c.getAttribute("data-js-button"),i=A(a,t),l=u(d);M(i._id)||(l.push(i),m(d,l),L(),v(i._id,0)),n.closest(".button-add-product").classList.add("visually-hidden"),c.classList.remove("visually-hidden")}else if(n.closest(".button-remove-product")){const c=n.closest(".button-remove-product").getAttribute("data-js-button"),a=A(c,t),i=u(d),l=M(a._id);m(d,i.filter(g=>l._id!==g._id)),L(),v(a._id,-1),n.closest(".button-remove-product").classList.add("visually-hidden"),n.closest(".button-remove-product").nextElementSibling.classList.remove("visually-hidden")}}Q.addEventListener("click",o)}).catch(t=>{console.error(t)});function It(t){Y(t).then(e=>{j(e)}).catch(e=>{console.error(e)})}function A(t,e){return e.find(s=>s._id.toString()===t)}function M(t){return u(d).find(o=>o._id===t)}function Bt(t,e){return t.length>e?t.slice(0,e-1)+"…":t}function xt(t){return t.map(({_id:e,name:o,img:s,category:n,popularity:c,size:a,price:i,is10PercentOff:l})=>{const g=parseInt(c.toString()[0]),b=Bt(o,14);return`  <li class="popular-item">
...
`}).join("")}function Mt(t,e){return t.length>e?t.slice(0,e-1)+"…":t}let $=[];const N=document.querySelector(".products-discount");async function Tt(){$=(await ct()).slice(0,2);const e=u(d),o=qt(e),s=At($,o);Ct(s)}Tt();function Ct(t){N.insertAdjacentHTML("beforeend",t)}N.addEventListener("click",_t);N.addEventListener("click",jt);function _t(t){const e=t.target.closest(".card-product-btn");if(!e)return;const o=t.target.closest(".card-product-discount");e.querySelectorAll("svg");const s=o.dataset.id,n=u(d);if(n.find(c=>s===c._id))m(d,n.filter(c=>s!==c._id)),L(),v(s,-1);else{const c=$.find(a=>s===a._id);n.push(c),m(d,n),L(),v(s,0)}}function jt(t){const e=t.target.closest(".card-product-discount"),o=t.target.closest(".card-product-btn");if(!e||o)return;const s=e.dataset.id,n=$.find(c=>s===c._id);j(n)}function qt(t=[]){return t.map(e=>e._id)}const r=document.querySelector(".feedback-form"),E="feedback-form-state",et=document.getElementById("footer-button"),y={menu:document.querySelector("[data-menu]"),one:document.querySelector("[data-one]"),two:document.querySelector("[data-two]")};r.addEventListener("submit",Ot);function Ot(t){t.preventDefault();const e=r.elements.email.value;at(e).then(o=>{o.message&&(y.menu.classList.remove("is-hidden"),y.one.classList.remove("is-hidden")),y.two.classList.add("is-hidden")}).catch(o=>{y.menu.classList.remove("is-hidden"),y.two.classList.remove("is-hidden"),y.one.classList.add("is-hidden")})}const Ft=rt(()=>{const t={email:r.elements.email.value};localStorage.setItem(E,JSON.stringify(t))},500);window.addEventListener("load",()=>{const t=localStorage.getItem(E);if(t){const{email:e}=JSON.parse(t);r.elements.email.value=e}});r.addEventListener("input",()=>{Ft(),k()});r.addEventListener("submit",t=>{t.preventDefault(),r.elements.email.value,localStorage.removeItem(E),r.reset(),k()});et.addEventListener("click",function(){console.log("Button clicked");const t=localStorage.getItem(E);if(t){const{email:e}=JSON.parse(t);r.elements.email.value=e,k()}});const k=()=>{const t=r.elements.email.value,e=Nt(t),o=t.trim()!=="";et.disabled=!(e&&o)},Nt=t=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t),Dt=()=>{const t=localStorage.getItem(E);if(t){const{email:e}=JSON.parse(t);r.elements.email.value=e,k()}};Dt();document.body.style.overflow="auto";(()=>{const t={openMenuBtn:document.querySelector("[data-menu-open]"),closeMenuBtn:document.querySelector("[data-menu-close]"),menu:document.querySelector("[data-menu]")};function e(){t.menu.classList.toggle("is-hidden"),document.body.classList.toggle("no-scroll"),t.menu.classList.contains("is-hidden")?document.body.style.overflow="auto":document.body.style.overflow="hidden"}Array.from(t.menu.children).forEach(c=>{c.addEventListener("click",s)});function s(){t.menu.classList.add("is-hidden"),document.body.classList.remove("no-scroll"),document.body.style.overflow="auto"}t.openMenuBtn.addEventListener("click",e),t.closeMenuBtn.addEventListener("click",e);function n(c){c.key==="Escape"&&e()}document.addEventListener("keydown",n)})();const C=document.getElementById("scrollToTopBtn"),W=360;window.onscroll=function(){document.body.scrollTop>W||document.documentElement.scrollTop>W?C.classList.add("show"):C.classList.remove("show")};C.addEventListener("click",function(){window.scrollTo({top:0,behavior:"smooth"})});
