import{g as l,a as m,b as R,s as u,d as q,e as K,f as Y,h as X}from"./assets/STORAGE-c79b7cc6.js";import{P as Z,a as tt,l as et}from"./assets/vendor-8c378b12.js";const j=document.getElementById("addToCartIcon"),w=document.getElementById("removeFromIcon");w.classList.add("visually-hidden");const y=document.getElementById("modalProduct"),ot=document.getElementById("closeModalProductBtn"),$=document.getElementById("addToCartBtn"),I=document.getElementById("removeFrom"),st=document.getElementById("modalProductImage"),ct=document.getElementById("modalProductName"),nt=document.getElementById("modalProductCategory"),at=document.getElementById("modalProductSize"),dt=document.getElementById("modalProductPopularity"),rt=document.getElementById("modalProductDescription"),it=document.getElementById("modalProductPrice");let f=!1;function _(t){if(!t||!t.img){console.error("Product data is missing or incomplete.");return}y.style.display="block",document.body.style.overflow="hidden",document.querySelector(".modal-overlay").style.display="flex",window.addEventListener("click",k),$.addEventListener("click",()=>{const e=l();e.find(s=>s._id===t._id)||(e.push(t),m(e),A(!0),f=!0)}),I.addEventListener("click",()=>{lt(t,!0),A(!1),f=!1}),st.src=t.img,ct.textContent=t.name,nt.innerHTML=`Category: <span id="priceText">$ ${t.category}</span>`,document.getElementById("priceText").style.color="black",at.innerHTML=`Size: <span id="priceTexte">$ ${t.size}</span>`,document.getElementById("priceTexte").style.color="black",dt.innerHTML=`Popularity: <span id="priceTex">$ ${t.popularity}</span>`,document.getElementById("priceTex").style.color="black",rt.textContent=`${t.desc}`,it.textContent=`$ ${t.price}`,y.style.display="block",document.body.style.overflow="hidden",document.querySelector(".modal-overlay").style.display="block",window.addEventListener("click",k)}function lt(t,e=!1){const o=l(),s=o.find(c=>c._id===t._id);e?s&&m(o.filter(c=>c._id!==t._id)):s||(o.push(t),m(o))}function O(){document.body.style.overflow="",y.style.display="none",document.querySelector(".modal-overlay").style.display="none",window.removeEventListener("click",k),f=!1}ot.addEventListener("click",O);document.addEventListener("keydown",function(t){t.key==="Escape"&&O()});function k(t){t.target===y&&O()}function A(t){const e=l();t?(j.classList.add("added-to-cart"),w.classList.remove("added-to-cart")):(j.classList.remove("added-to-cart"),w.classList.add("added-to-cart")),e.length>0?(I.classList.remove("visually-hidden"),$.classList.add("visually-hidden")):(I.classList.add("visually-hidden"),$.classList.remove("visually-hidden"))}document.addEventListener("DOMContentLoaded",()=>{l().find(o=>o._id===product._id)&&(f=!0),A(f)});const T=document.querySelector(".list-prod"),D="added-item",Q="firstGet";function B(t,e){localStorage.setItem(t,JSON.stringify(e))}function V(t){try{const e=localStorage.getItem(t);return e?JSON.parse(e):[]}catch(e){console.log(e)}}function ut(t,e){t.innerHTML=e}async function J(t){const e=ft(t);ut(T,e)}const L=V(Q);console.log(L);const G=gt(L);console.log(G);const x=G.includes(L._id);console.log(x);T.addEventListener("click",pt);T.addEventListener("click",mt);function pt(t){const e=t.target.closest(".buy-btn");if(!e)return;const o=t.target.closest(".prod-item"),s=e.querySelectorAll("svg"),c=o.getAttribute("data-js-product-id");console.log(c);const n=V(Q);if(console.log(n),n.find(a=>c===a._id)){const a=n.filter(d=>c!==d._id);B(D,a)}else{const a=products.find(d=>c===d._id);n.push(a),B(D,n)}s.forEach(a=>{a.classList.toggle("is-hidden")})}function mt(t){const e=t.target.closest(".prod-item"),o=t.target.closest(".buy-btn");if(!e||o)return;const s=e.getAttribute("data-js-product-id");L.find(c=>s===c._id),R(s).then(c=>{_(c)}).catch(c=>{console.error(c)})}function gt(t=[]){return t.map(e=>e._id)}function ft(t){const e=x?"":"is-hidden",o=x?"is-hidden":"";return t.map(({_id:s,name:c,img:n,category:a,size:d,price:r,popularity:p})=>`
    ...
    </div>`),B("firstGet",c),J(c),n>1){const a={totalItems:c.length*n,itemsPerPage:s.limit,visiblePages:5,page:1,centerAlign:!0,usageStatistics:!1};window.matchMedia("(max-width: 375px)").matches?a.visiblePages=3:window.matchMedia("(min-width: 768px)").matches&&(a.visiblePages=5),new Z(ht,a).on("afterMove",async r=>{s.page=r.page;const{results:p}=await q(s);J(p)})}}class vt{constructor(){this.URL="https://food-boutique.b.goit.study/api",this.searchQuery="",this.category="",this.currentPage=1,this.perPage=90}paramsFromApi(e){return Object.entries(e).map(([o,s])=>`${encodeURIComponent(o)}=${encodeURIComponent(s)}`).join("&")}getFoodList(){const e={keyword:this.searchQuery,category:this.category,page:this.currentPage,limit:this.perPage},o=this.paramsFromApi(e);return tt.get(`${this.URL}/products?${o}`).then(s=>s.data)}}class bt{updateLsWithList(e,o){localStorage.getItem("options")||this.defaultApiOptions(),localStorage.setItem("products",JSON.stringify(e.results)),localStorage.setItem("options",JSON.stringify(o))}defaultApiOptions(){const e={keyword:null,category:null,page:1,limit:6};localStorage.setItem("options",JSON.stringify(e))}}document.querySelector(".list-prod");const Lt=document.querySelector(".filter-form"),v=document.querySelector(".filter-select"),g=new vt,C=new bt;K().then(t=>{t.forEach(o=>{const s=document.createElement("option");s.value=o,s.textContent=o,v.appendChild(s)});const e=St();v.appendChild(e)});function St(){const t=document.createElement("option");return t.textContent="Show All",t.value="",t}Lt.addEventListener("submit",function(t){t.preventDefault();const e=t.target.elements.searchQuery.value;console.log("Search Value:",e);try{let o=JSON.parse(localStorage.getItem("options"))||{};o.keyword=e,g.searchQuery=e,console.log("foodApi.searchQuery:",g.searchQuery),g.getFoodList().then(function(s){C.updateLsWithList(s,o);const n=JSON.parse(localStorage.getItem("products")).length;console.log(n),F(o)}).catch(function(s){console.error("Error fetching food list:",s.message)})}catch(o){console.error("Error:",o.message)}});v.addEventListener("change",function(){const t=v.value;try{let e=JSON.parse(localStorage.getItem("options"))||{};t==="show-all"?(localStorage.removeItem("products"),C.defaultApiOptions(),document.getElementById("search").value="",categoriesFilter()):(e.category=t,g.category=t,g.getFoodList().then(function(o){C.updateLsWithList(o,e);const c=JSON.parse(localStorage.getItem("products")).length;console.log(e),F(e)}).catch(function(o){console.error("Error fetching list:",o.message)}))}catch(e){console.error("Error:",e.message)}});const z=document.querySelector(".popular-list");Y(5).then(t=>{z.insertAdjacentHTML("beforeend",wt(t)),[...document.getElementsByClassName("product-added")].forEach(s=>{const c=s.getAttribute("data-js-btn"),n=E(c,t);P(n._id)&&s.nextElementSibling.classList.add("visually-hidden")});function o(s){let c=s.target;if(c.closest(".popular-card")){const a=c.closest(".popular-card").getAttribute("data-js-product-id");Et(a)}else if(c.closest(".btn-add")){const n=c.closest(".btn-add").previousElementSibling,a=n.getAttribute("data-js-btn"),d=E(a,t),r=l();P(d._id)||(r.push(d),m(r)),c.closest(".btn-add").classList.add("visually-hidden"),n.classList.remove("visually-hidden")}else if(c.closest(".product-added")){const n=c.closest(".product-added").getAttribute("data-js-btn"),a=E(n,t),d=l(),r=P(a._id);m(d.filter(p=>r._id!==p._id)),c.closest(".product-added").classList.add("visually-hidden"),c.closest(".product-added").nextElementSibling.classList.remove("visually-hidden")}}z.addEventListener("click",o)}).catch(t=>{console.error(t)});function Et(t){R(t).then(e=>{_(e)}).catch(e=>{console.error(e)})}function E(t,e){return e.find(s=>s._id.toString()===t)}function P(t){return l().find(o=>o._id===t)}function Pt(t,e){return t.length>e?t.slice(0,e-1)+"…":t}function wt(t){return t.map(({_id:e,name:o,img:s,category:c,popularity:n,size:a,price:d,is10PercentOff:r})=>{const p=parseInt(n.toString()[0]),W=Pt(o,14);return`  <li class="popular-item">
      ...
      </li>`}).join("")}function $t(t=[],e=[]){return t.map(o=>{const s=e.includes(o._id),c=s?"":"is-hidden",n=s?"is-hidden":"",a=It(o.name,14);return` <div class="card-product-discount" data-id="${o._id}">
...
`}).join("")}function It(t,e){return t.length>e?t.slice(0,e-1)+"…":t}let b=[];const N=document.querySelector(".products-discount");async function kt(){b=(await X()).slice(0,2);const e=l(),o=Ct(e),s=$t(b,o);At(s)}kt();function At(t){N.insertAdjacentHTML("beforeend",t)}N.addEventListener("click",Bt);N.addEventListener("click",xt);function Bt(t){const e=t.target.closest(".card-product-btn");if(!e)return;const o=t.target.closest(".card-product-discount"),s=e.querySelectorAll("svg"),c=o.dataset.id,n=l();if(n.find(a=>c===a._id))m(n.filter(a=>c!==a._id));else{const a=b.find(d=>c===d._id);n.push(a),m(n)}s.forEach(a=>{a.classList.toggle("is-hidden")})}function xt(t){const e=t.target.closest(".card-product-discount"),o=t.target.closest(".card-product-btn");if(!e||o)return;const s=e.dataset.id,c=b.find(n=>s===n._id);_(c)}function Ct(t=[]){return t.map(e=>e._id)}const i=document.querySelector(".feedback-form"),h="feedback-form-state",U=document.getElementById("footer-button"),Mt=et(()=>{const t={email:i.elements.email.value};localStorage.setItem(h,JSON.stringify(t))},500);window.addEventListener("load",()=>{const t=localStorage.getItem(h);if(t){const{email:e}=JSON.parse(t);i.elements.email.value=e}});i.addEventListener("input",()=>{Mt(),S()});i.addEventListener("submit",t=>{t.preventDefault();const e={email:i.elements.email.value};console.log(e),localStorage.removeItem(h),i.reset(),S()});U.addEventListener("click",function(){const t=localStorage.getItem(h);if(t){const{email:e}=JSON.parse(t);i.elements.email.value=e,S()}});const S=()=>{const t=i.elements.email.value,e=_t(t),o=t.trim()!=="";U.disabled=!(e&&o)},_t=t=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t),Ot=()=>{const t=localStorage.getItem(h);if(t){const{email:e}=JSON.parse(t);i.elements.email.value=e,S()}};Ot();document.body.style.overflow="auto";(()=>{const t={openMenuBtn:document.querySelector("[data-menu-open]"),closeMenuBtn:document.querySelector("[data-menu-close]"),menu:document.querySelector("[data-menu]")};t.openMenuBtn.addEventListener("click",e),t.closeMenuBtn.addEventListener("click",e);function e(){t.menu.classList.toggle("is-hidden"),document.body.classList.toggle("no-scroll"),document.body.style.overflow=t.menu.classList.contains("is-hidden")?"auto":"hidden"}Array.from(t.menu.children).forEach(c=>{c.addEventListener("click",s)});function s(){t.menu.classList.add("is-hidden"),document.body.classList.remove("no-scroll"),document.body.style.overflow="auto"}})();const M=document.getElementById("scrollToTopBtn"),H=360;window.onscroll=function(){document.body.scrollTop>H||document.documentElement.scrollTop>H?M.classList.add("show"):M.classList.remove("show")};M.addEventListener("click",function(){window.scrollTo({top:0,behavior:"smooth"})});
